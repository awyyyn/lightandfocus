        ...
        <section className='flex h-auto md:h-screen w-screen relative flex-col'>
            ...
            <div className='h-5/6  w-screen flex flex-col md:flex-row transition-all '>
                ...
                <motion.div
                    ...
                    transition={{duration: 2, type: 'keyframes  ', stiffness: 44}}
                    ...
                    <div className='bg-[#9DF3FF] w-[80%]  h-3/6 md:overflow-y-scroll  rounded-3xl relative overflow-x-hidden' >
                        <div className='sticky top-0 left-0 opacity-90  w-full h-10 bg-[#9DF3FF]' />
                        ...
                        <div className='px-8'>
                            ...
                            <h1 className='text-md font-bold mt-3 uppercase'>Save my Package</h1>
                            ...
                            <button className='mt-16  mb-2 text-center w-full text-outline hover:drop-shadow-md cursor-pointer transition-all hover:scale-[1.1] '>Pick me up</button>
                        </div> 
                        <div className='sticky top-0 bottom-0 opacity-90  w-full h-10 bg-[#9DF3FF]' />
                    </div> 
                </motion.div>  
            </div> 
